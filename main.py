from sensorplace.utility import generate_graph_from_file, add_sensors_to_node, get_active_sensors_from_result
...
active_sensors = get_active_sensors_from_result(result)

add_sensors_to_node(G, active_sensors)
